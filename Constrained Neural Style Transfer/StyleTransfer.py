...
logo_name = 'k'
style_name = 'flower' # colorful_flower, bells
background = '' # '_background'

# Content image to use.
content_input_path = f"input/contents/logo/{logo_name}/"
content_with_ext   = f"{logo_name}_logo{background}.png"
content_image_path = content_input_path + content_with_ext
content_image      = content_with_ext[:-4]

# Style image to use.
style_input_path   = "input/styles/"
style_with_ext     = f"{style_name}.png" # colorful_flower.jpg, bells.jpg
...
if __name__ == '__main__':
    ...
    with tf.device("/gpu:0"):
        # tf.compat.v1.disable_eager_execution()  # 필요한 경우 이 줄을 추가
